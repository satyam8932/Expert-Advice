...
const PageWrapper = ({ children }: { children: React.ReactNode }) => (
    <div className="min-h-screen w-full bg-background text-foreground flex flex-col items-center justify-center p-4 sm:p-6 relative selection:bg-indigo-500/30">
        ...
        <div className="relative z-10 w-full max-w-3xl animate-in fade-in zoom-in duration-500">
            <div className="flex justify-center mb-8">
                <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 border border-border backdrop-blur-sm">
                    <Ghost className="w-5 h-5 text-indigo-500 dark:text-indigo-400" />
                    <span className="font-bold text-foreground tracking-tight">
                        Advice<span className="text-indigo-500 dark:text-indigo-400">Expert</span>.io
                    </span>
                </div>
            </div>

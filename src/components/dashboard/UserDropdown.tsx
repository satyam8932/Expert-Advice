    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-64 p-1 bg-popover backdrop-blur-sm border border-border shadow-lg rounded-xl" sideOffset={8}>
                ...
                <DropdownMenuItem onClick={onLogout} className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-red-400 rounded-lg cursor-pointer transition-colors hover:bg-red-500/10 focus:bg-red-500/10">
